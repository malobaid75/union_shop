...
class DataService {
  ...
  final List<Product> products = [
    ...
    Product(
      ...
      price: 18.00,
      images: [
        'https://via.placeholder.com/500x500/E74C3C/FFFFFF?text=T-Shirt+Front',
        'https://via.placeholder.com/500x500/F74C3C/FFFFFF?text=T-Shirt+Back',
      ],
      sizes: ['XS', 'S', 'M', 'L', 'XL'],
    ...
    Product(
      ...
      originalPrice: 70.00,
      images: [
        'https://via.placeholder.com/500x500/8E44AD/FFFFFF?text=Jacket+Front',
        'https://via.placeholder.com/500x500/9E54BD/FFFFFF?text=Jacket+Back',
      ],
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['Navy', 'Black'],
      category: 'Clothing',
    ...
    Product(
      ...
      originalPrice: 50.00,
      images: [
        'https://via.placeholder.com/500x500/C0392B/FFFFFF?text=Zip+Hoodie',
      ],
      sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
    ...
    Product(
      ...
      price: 24.00,
      images: [
        'https://via.placeholder.com/500x500/16A085/FFFFFF?text=Polo+Shirt',
      ],
      sizes: ['S', 'M', 'L', 'XL'],
    ...
    Product(
      ...
      price: 28.00,
      images: [
        'https://via.placeholder.com/500x500/F39C12/FFFFFF?text=Sports+Jersey',
      ],
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['Blue', 'White'],
      category: 'Clothing',
    ...
    Product(
      ...
      originalPrice: 45.00,
      images: [
        'https://via.placeholder.com/500x500/27AE60/FFFFFF?text=Backpack',
      ],
      sizes: ['One Size'],
      colors: ['Navy', 'Black', 'Grey'],
    ...
    Product(
      ...
      originalPrice: 15.00,
      images: [
        'https://via.placeholder.com/500x500/E74C3C/FFFFFF?text=Beanie',
      ],
      sizes: ['One Size'],
    ...
    Product(
      ...
      originalPrice: 18.00,
      images: [
        'https://via.placeholder.com/500x500/E67E22/FFFFFF?text=Scarf',
      ],
      sizes: ['One Size'],
      colors: ['Navy/Gold'],
      category: 'Accessories',
    ...
    Product(
      ...
      price: 14.00,
      images: [
        'https://via.placeholder.com/500x500/3498DB/FFFFFF?text=Cap',
      ],
      sizes: ['One Size'],
    ...
    Product(
      ...
      price: 8.00,
      images: [
        'https://via.placeholder.com/500x500/9B59B6/FFFFFF?text=Mug',
      ],
      sizes: ['One Size'],
      colors: ['White', 'Navy'],
      category: 'Drinkware',
    ...
    Product(
      ...
      originalPrice: 12.00,
      images: [
        'https://via.placeholder.com/500x500/16A085/FFFFFF?text=Water+Bottle',
      ],
      sizes: ['500ml', '750ml'],
    ...
    Product(
      ...
      price: 15.00,
      images: [
        'https://via.placeholder.com/500x500/34495E/FFFFFF?text=Travel+Mug',
      ],
      sizes: ['One Size'],
    ...
    Product(
      ...
      price: 12.00,
      images: [
        'https://via.placeholder.com/500x500/F39C12/FFFFFF?text=Notebooks',
      ],
      sizes: ['A4', 'A5'],
      colors: ['Navy', 'Black'],
      category: 'Stationery',
    ...
    Product(
      ...
      price: 6.00,
      images: [
        'https://via.placeholder.com/500x500/2ECC71/FFFFFF?text=Pen+Set',
      ],
      sizes: ['One Size'],
    ...
    Product(
      ...
      originalPrice: 25.00,
      images: [
        'https://via.placeholder.com/500x500/9B59B6/FFFFFF?text=Laptop+Sleeve',
      ],
    ...
    Product(
      ...
      price: 12.00,
      images: [
        'https://via.placeholder.com/500x500/8E44AD/FFFFFF?text=Phone+Case',
      ],
    ...
    Product(
      ...
      price: 10.00,
      images: [
        'https://via.placeholder.com/500x500/E74C3C/FFFFFF?text=USB+Drive',
      ],
      sizes: ['32GB', '64GB'],
      colors: ['Navy', 'Black'],
      category: 'Tech',
    ...
    Product(
      ...
      originalPrice: 22.00,
      images: [
        'https://via.placeholder.com/500x500/3498DB/FFFFFF?text=Gym+Shorts',
      ],
      sizes: ['S', 'M', 'L', 'XL'],
      colors: ['Navy', 'Black', 'Grey'],
      category: 'Sports',
    ...
    Product(
      ...
      price: 10.00,
      images: [
        'https://via.placeholder.com/500x500/1ABC9C/FFFFFF?text=Towel',
      ],
      sizes: ['Small', 'Large'],
      colors: ['Navy', 'Grey'],
      category: 'Sports',
